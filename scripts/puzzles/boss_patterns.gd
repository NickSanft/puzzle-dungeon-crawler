...
const COLOR_PATTERNS := [
	...
	{
		"name": "The Ember Moth",
		"palette": [Color(0, 0, 0, 0), Color(0.95, 0.45, 0.25), Color(0.95, 0.85, 0.35), Color(0.35, 0.2, 0.15)],
		"grid": [
			"...1111...",
			"..122221..",
			".12222221.",
	...
	{
		"name": "The Frost Sigil",
		"palette": [Color(0, 0, 0, 0), Color(0.45, 0.72, 0.95), Color(0.2, 0.35, 0.65), Color(0.92, 0.95, 1.0)],
		"grid": [
			"....33....",
			"...3113...",
			"..31..13..",
